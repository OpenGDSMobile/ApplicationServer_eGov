...
import com.openGDSMobileApplicationServer.service.impl.OpenGDSMobileTableServiceImp;
 ...
 */
@RestController
@RequestMapping("/api/Collected.do")
public class DataCollectedController {
    /**
     ...
     */
    @Autowired
    OpenGDSMobileTableServiceImp dataCollectService;
     ...
     * @return
     */
    @RequestMapping (value="/{name}.do", method={RequestMethod.DELETE})
