...
import com.openGDSMobileApplicationServer.quartz.SchedulerManagement;
...
@Service
public class OpenGDSMobileTableServiceImp {
	 Logger log = LoggerFactory.getLogger(OpenGDSMobileTableServiceImp.class);
